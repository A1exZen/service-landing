...
const Register = () => {
	...
	// Варианты анимации для текста и формы (без задержки, более плавно)
	const fadeInLeft = {
	...
	// Варианты анимации для логотипа (без задержки)
	const fadeInLogo = {
	...
	// Варианты анимации для сообщения об ошибке
	const fadeInError = {
			...
			<form onSubmit={handleSubmit} className="w-full max-w-lg" >
				...
				>
					...
					<motion.div className="w-full text-center" variants={fadeInLeft}>
						...
						>
							<motion.span
								whileHover={{ color: '#4b5563', transition: { duration: 0.3, ease: 'easeOut' } }}
							>
